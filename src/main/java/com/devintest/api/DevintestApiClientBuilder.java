...
public class DevintestApiClientBuilder {
    ...
    public DevintestApiClientBuilder url(String url) {
     ...
     */
    public DevintestApiClientBuilder timeout(int timeout) {
     ...
     */
    public DevintestApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public DevintestApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public DevintestApiClientBuilder addHeader(String name, String value) {
    ...
    public DevintestApiClient build() {
        validateConfiguration();
        return new DevintestApiClient(buildClientOptions());
    }
}
