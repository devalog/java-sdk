...
public class AsyncRawImdbClient {
     ...
     */
    public CompletableFuture<DevintestApiHttpResponse<String>> createMovie(CreateMovieRequest request) {
     ...
     * Add a movie to the database
     */
    public CompletableFuture<DevintestApiHttpResponse<String>> createMovie(
        ...
        CompletableFuture<DevintestApiHttpResponse<String>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new DevintestApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), String.class), response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new DevintestApiApiException(
                    ...
                    future.completeExceptionally(new DevintestApiException("Network error executing HTTP request", e));
                }
            }
     ...
     */
    public CompletableFuture<DevintestApiHttpResponse<Movie>> getMovie(String id) {
     ...
     * Retrieve a movie from the database based on the ID
     */
    public CompletableFuture<DevintestApiHttpResponse<Movie>> getMovie(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("movies")
                .addPathSegment(id)
        ...
        CompletableFuture<DevintestApiHttpResponse<Movie>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
